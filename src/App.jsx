...
const App = () => {
  ...
  useEffect(() => {
    const handlePopState = (event) => {
      if (isQuoteModalOpen) {
        // Prevent the default back behavior and close modal instead
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative transform overflow-hidden rounded-xl bg-white shadow-xl transition-all w-full max-w-sm">
              ...
              <div className="px-6 py-6 text-center">
                ...
                {/* Simplified buttons - following user preference */}
